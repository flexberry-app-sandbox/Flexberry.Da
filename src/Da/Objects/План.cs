...
namespace IIS.Da
{
    ...
    public class План : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Da.ПланЗакупок fПланЗакупок;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Da.ПланЗакупок.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ПланЗакупок"})]
        public virtual IIS.Da.ПланЗакупок ПланЗакупок
        {
            get
            {
                ...
                IIS.Da.ПланЗакупок result = this.fПланЗакупок;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПланE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланE", typeof(IIS.Da.План));
                }
            }
        }
    }
    ...
    public class DetailArrayOfПлан : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Da.DetailArrayOfПлан members)

        // *** End programmer edit section *** (IIS.Da.DetailArrayOfПлан members)
        ...
        /// </summary>
        public DetailArrayOfПлан(IIS.Da.ПланЗакупок fПланЗакупок) : 
                base(typeof(План), ((ICSSoft.STORMNET.DataObject)(fПланЗакупок)))
        {
        }
        
        public IIS.Da.План this[int index]
        {
            get
            {
                return ((IIS.Da.План)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Da.План dataobject)
        {
