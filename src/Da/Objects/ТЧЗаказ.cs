...
namespace IIS.Da
{
    ...
    [View("ТЧЗаказE", new string[] {
            ...
            "ЕдиницыИзмер.ЕдиницаИзмер as \'ЕдиницаИзмер\'",
            "Цена as \'Цена\'",
            "ЭтоУслуга as \'Это услуга\'",
            "СуммаНДС as \'Сумма НДС\'",
            "Количество as \'Количество\'",
            "Сумма as \'Сумма\'",
            "Номенклатура.Контрагенты.Контрагент as \'Контрагенты\'"})]
    public class ТЧЗаказ : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Da.Номенклатура fНоменклатура;
        
        private IIS.Da.ЕдиницыИзмер fЕдиницыИзмер;
        
        private IIS.Da.ЗаказПост fЗаказПост;
        ...
        [PropertyStorage(new string[] {
                "ЕдиницыИзмер"})]
        [NotNull()]
        public virtual IIS.Da.ЕдиницыИзмер ЕдиницыИзмер
        {
            get
            {
                ...
                IIS.Da.ЕдиницыИзмер result = this.fЕдиницыИзмер;
        ...
        [PropertyStorage(new string[] {
                "Номенклатура"})]
        [NotNull()]
        public virtual IIS.Da.Номенклатура Номенклатура
        {
            get
            {
                ...
                IIS.Da.Номенклатура result = this.fНоменклатура;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Da.ЗаказПост.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ЗаказПост"})]
        public virtual IIS.Da.ЗаказПост ЗаказПост
        {
            get
            {
                ...
                IIS.Da.ЗаказПост result = this.fЗаказПост;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧЗаказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧЗаказE", typeof(IIS.Da.ТЧЗаказ));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧЗаказ : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Da.DetailArrayOfТЧЗаказ members)

        // *** End programmer edit section *** (IIS.Da.DetailArrayOfТЧЗаказ members)
        ...
        /// </summary>
        public DetailArrayOfТЧЗаказ(IIS.Da.ЗаказПост fЗаказПост) : 
                base(typeof(ТЧЗаказ), ((ICSSoft.STORMNET.DataObject)(fЗаказПост)))
        {
        }
        
        public IIS.Da.ТЧЗаказ this[int index]
        {
            get
            {
                return ((IIS.Da.ТЧЗаказ)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Da.ТЧЗаказ dataobject)
        {
